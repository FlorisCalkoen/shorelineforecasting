...
def evaluate_performance(s_true, s_pred, model_configs):
    true_y = s_true[model_configs['train_window']: model_configs['train_window'] + model_configs['output_size']].to_numpy()
    pred_y = s_pred[model_configs['train_window']: model_configs['train_window'] + model_configs['output_size']].to_numpy()
